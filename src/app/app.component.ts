...
export class AppComponent implements OnInit {
    ...
    createInspector(cell: joint.dia.Cell) {
        cell.on('change:attrs', input => {
            ...
            // console.log(input.attributes.attrs);
            // console.log(input.attributes.attrs['.label'].text);
    ...
    test() {
        ...
        // this.paper.on('element:pointerup', input => {
        //     console.log(`input`);
        //     console.log(input);
        //     console.log(`input.id`);
        //     console.log(input.id);
        //     console.log(`input.attributes.attrs`);
        //     console.log(input.model.attributes.attrs);
        //     console.log(input.model.attributes.attrs['.label'].text);

        //     input.on('change:attrs', (cell) => {
        //         console.log(`cell`);
        //         console.log(cell);
        //     })
    ...
    public loadFromJSON() {
        ...
        this.graph.fromJSON(jsonString);
    };
